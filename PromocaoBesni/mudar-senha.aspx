    ...
    <section id="banner-escrita-imagem">
        <div class="banner">
            <div class="centraliza">
                <div id="imagem-escrita">
                    <img src="assets/imagens/escrita-banner.png" alt="">
                </div>
                <div id="imagem-carro">
    ...
    <section id="onde-estamos">
        <div class="container">
            <div class="text-center">
                <h2 class="basenine text-uppercase vermelho">mudar senha
                </h2>
            </div>
            <div style="margin-top: 5%" class="text-center">
                ...
                <div class="row">
                    <div class="col-sm-8" style="margin: auto; float: none">
                        <span>Você pode alterar sua senha caso a esqueça. A sua senha será utilizada para acessar a área restrita para que você confira os seus cupons ou cadastre outros. 
                        </span>
                    </div>
                </div>
                    ...
                    <div class="col-md-5" style="margin: auto; float: none">
                        <form class="recuperaPass" action="/ajax/acoes.aspx">
                            ...
                            <div class="inputWrapper">
                                ...
                                <input name="senha" id="senha" class="inputs" type="password">
                            </div>

                            <div class="inputWrapper">
                                <div class="labelFormTwo"><span>Confirmar</span> Senha</div>
                                <input name="senha2" id="senha2" class="inputs" type="password">
                            </div>
                            <div>
                                <p ><center style="height: 15px; margin-bottom:25px; color:#ff0000;" id="msg">&nbsp;</center></p>
                            </div>

                            <input type="submit" id="btnEnviar" value="Alterar" class="novaSenhaClick btn-form btn-enviar" />
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            if (url.indexOf("sucesso") > 1) {
                $('#msg').html("Senha alterada com sucesso!");
                $('#btnEnviar').attr("value", "Aguarde...");
                $('#senha').attr("readonly", "readonly");
                $('#senha2').attr("readonly", "readonly");

                setTimeout(function () {
                    window.location.href = "/cadastro-abertura.aspx"
                }, 3000);
