	...
	<div class="container">
		...
		<div class="row" style="margin-top: 40px;">
			<div class="col-sm-10 col-md-8 sorteios" style="margin: auto;float: none">
				<div class="row">
					<div class="col-sm-3 text-uppercase text-center passou">
						<div class="botao">
							<span>Sorteio</span>
							<span>09/11/2017</span>
							<span class="premio">10 motos</span>
						</div>
						<div class="mostra-codigos">
					...
					<div class="col-sm-3 text-uppercase text-center atual">
						<div class="botao">
							<span>Sorteio</span>
					...
					<div class="col-sm-3 text-uppercase text-center proximo">
						<div class="botao">
							<span>Sorteio</span>
					...
					<div class="col-sm-3 text-uppercase text-center proximo">
						<div class="botao">
							...
							<span class="premio">10 motos</span>
							<span class="premio">1 jeep renegade</span>
						</div>
						<div class="mostra-codigos">
